...
print("member-get-keyword", catch(lambda: version_major.__get__(obj=sys.version_info)))
...
print("member-set-keyword", catch(lambda: version_major.__set__(obj=sys.version_info, value=9)))
...
print("member-delete-keyword", catch(lambda: version_major.__delete__(obj=sys.version_info)))
