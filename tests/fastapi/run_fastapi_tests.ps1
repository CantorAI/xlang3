...
try {
    ...
    foreach ($case in @('pydantic_features', 'pydantic_common_types', 'pydantic_constraints', 'pydantic_serializers', 'pydantic_urls', 'pydantic_core_schemas', 'pydantic_validators', 'pydantic_enums', 'pydantic_structures', 'pydantic_dataclasses', 'asgi_end_to_end', 'framework_features', 'advanced_asgi_features', 'testclient_features')) {
