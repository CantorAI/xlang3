...
CORE_CASES = [
    ...
    "inherited_getattr_slots",
    "prepared_namespace_transform",
    "private_slots_mangling",
    "descriptor_protocol",
    "partialmethod_init_keywords",
    "instance_stored_descriptor_value",
    "default_object_repr",
    ...
    "branch_join_instruction_fusion",
    "builtin_types_edges",
    "set_subclass_protocol",
    ...
    "union_typing_alias",
    "int_base_keyword",
    "overlapped_iocp_wait",
    "socket_ipx_family",
    "bytearray_repetition",
    "bigint_bytes_linear",
    "nested_comprehension_capture",
    "bytesio_export_lifetime",
    "module_attribute_delete",
    "asyncio_dual_stack_listener",
    "winapi_pipe_poll",
    "os_kill_intenum",
    "dict_init_mappingproxy",
    "ast_runtime_parser",
    "ast_import_roundtrip",
    "ast_raise_roundtrip",
    "compile_ast_module",
    ...
    "weakref_module",
    "dataclass_gc",
    "numeric_hash_invariant",
    "unicode_repr_surrogate",
    "inspect_module",
    ...
    "package_import",
    "import_system_model",
    "relative_import_ellipsis_compile",
    "vfs_file_io",
    "file_context_open",
    "file_io_compat",
    "filesystem_io_edges",
    "io_wrapper_getattr_buffer",
    "io_open_layering",
    "thread_daemon_cleanup",
...
NEGATIVE_CASES = [
    ...
    ("unset_instance_attr", 1, ["Traceback (most recent call last):", "AttributeError: 'A' object has no attribute 'x'"]),
]
