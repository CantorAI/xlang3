...
bool stat_file_type(Runtime&, const Value* args, uint32_t argc, Value& out, std::string& error, void* user_data) {
  int64_t mode = 0;
  const std::string_view name = static_cast<const char*>(user_data);
  if (!stat_mode_arg(args, argc, mode, error, name.data())) {
    return false;
  }
  if (name == "S_ISDOOR" || name == "S_ISPORT" || name == "S_ISWHT") {
    value_set_bool(out, false);
    return true;
  }
  const int64_t expected = name == "S_ISDIR" ? 0040000 :
      name == "S_ISREG" ? 0100000 :
      name == "S_ISLNK" ? 0120000 :
      name == "S_ISCHR" ? 0020000 :
      name == "S_ISBLK" ? 0060000 :
      name == "S_ISFIFO" ? 0010000 : 0140000;
...
void register_stat_module(Runtime& runtime) {
  ...
  builder.value("ST_MODE", Value::int64(0))
      ...
      .value("S_IFDOOR", Value::int64(0))
      .value("S_IFPORT", Value::int64(0))
      .value("S_IFWHT", Value::int64(0))
      .value("S_IRUSR", Value::int64(0400))
      .value("S_IWUSR", Value::int64(0200))
      .value("S_IXUSR", Value::int64(0100))
      .value("S_IRWXU", Value::int64(0700))
      .value("S_IRGRP", Value::int64(0040))
      .value("S_IWGRP", Value::int64(0020))
      .value("S_IXGRP", Value::int64(0010))
      .value("S_IRWXG", Value::int64(0070))
      .value("S_IROTH", Value::int64(0004))
      .value("S_IWOTH", Value::int64(0002))
      .value("S_IXOTH", Value::int64(0001))
      .value("S_IRWXO", Value::int64(0007))
      .value("S_IREAD", Value::int64(0400))
      .value("S_IWRITE", Value::int64(0200))
      .value("S_IEXEC", Value::int64(0100))
      .value("S_ISUID", Value::int64(04000))
      .value("S_ISGID", Value::int64(02000))
      .value("S_ENFMT", Value::int64(02000))
      .value("S_ISVTX", Value::int64(01000))
      ...
      .value("S_ISDOOR", runtime.make_native_function("_stat.S_ISDOOR", stat_file_type, const_cast<char*>("S_ISDOOR")))
      .value("S_ISPORT", runtime.make_native_function("_stat.S_ISPORT", stat_file_type, const_cast<char*>("S_ISPORT")))
      .value("S_ISWHT", runtime.make_native_function("_stat.S_ISWHT", stat_file_type, const_cast<char*>("S_ISWHT")));
